...
def agrega(caminho_anexo,nome_fornecedor):
    ...
    dados_nova_planilha = pd.read_csv(caminho_anexo)
    ...
    dados_sem_fornecedor_atual = dados_planilha_unificada.loc[dados_planilha_unificada.Fornecedor != nome_fornecedor] # # carrega todos os dados da planilha unificada com exceção dos dados do fornecedor que será atualizado pelo novo arquivo do fornecedor
    dados_nova_planilha['Fornecedor'] = nome_fornecedor      
